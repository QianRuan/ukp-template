...
- 🔄 Continuous integration using [Github Actions](https://github.com/QianRuan/ukp-template/actions) with jobs to check, lint and test your project.
...
It contains [GitHub Actions](https://docs.github.com/en/actions) that are executed automatically when pushing your code. You can see results for your repository [here](https://github.com/QianRuan/ukp-template/actions).
